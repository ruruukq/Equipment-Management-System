...
// Fetch all products (same as in your original code)
$sql = "SELECT 
...
<body>
<a href="../manage-equipments.php" class="no-print" style=" padding: 10px; background-color: #1B4D3E; color: white; text-decoration: none; display: inline-block; border-radius: 5px;">Back</a>
    ...
    <div class="table-wrapper">
        <table cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: collapse;">
            <tr class="heading">
                ...
                <td style="text-align: center; font-weight: bold; background-color: #f2f2f2;">Brand</td>
                <td style="text-align: center; font-weight: bold; background-color: #f2f2f2;">Quantity</td>
                <td style="text-align: center; font-weight: bold; background-color: #f2f2f2;">Price</td>
            ...
            ?>
            <tr class="item">
                <td style="text-align: center;"><?php echo date("F j, Y", strtotime($product->RegDate)); ?></td>
                <td style="text-align: left;"><?php echo htmlentities($product->ProductName); ?></td>
                <td style="text-align: center;"><?php echo htmlentities($product->BrandName); ?></td>
                <td style="text-align: center;"><?php echo htmlentities($product->productQty); ?></td>
                <td style="text-align: center;">₱<?php echo number_format($product->ProductPrice, 2); ?></td>
                <td style="text-align: center;">₱<?php echo number_format($itemTotal, 2); ?></td>
            </tr>
            <?php } ?>
            <tr class="total">
                <td colspan="5" style="border-top: 3px solid #000;"></td>
                <td style="font-weight: bold; border-top: 3px solid #000; text-align: right; padding-right: 5px;">
