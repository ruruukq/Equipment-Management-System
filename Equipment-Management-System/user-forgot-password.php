...
if (isset($_POST['change'])) {
    ...
    try {
        ...
        $stmt = $dbh->prepare("UPDATE tblusers SET password = :password WHERE EmailId = :email");
...
<input class="form-control" type="email" name="email" required autocomplete="off" />
 ...
 <button type="submit" name="change" class="btn btn-info" style="background-color: #1B4D3E; color: #fff;">SUBMIT</button> | <a href="index.php#login">Login</a>
</form>
 </div>
</div>
</div>
